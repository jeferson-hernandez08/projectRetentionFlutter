  ...
  showModalBottomSheet(
    ...
    builder: (context) {
      return Scaffold(
        ...
        appBar: AppBar(
          title: Text('Confirmar Eliminación de la Estrategia'),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ElevatedButton(
                              onPressed: () async {
                                try {
                                  // Lógica para eliminar la estrategia | Llamamos la función API apiRetention.dart
                                  await deleteStrategyApi(itemList['id']);  
                                  ...
                                  Get.snackbar(
                                    'Error',
                                    'Error al eliminar estrategia: ${e.toString()}',
                                    backgroundColor: Colors.red,
                                    colorText: Colors.white,
                                  );
                                }
